...
- **Generic metrics collection** (`rpc/main.go`) - iterates over discovered components instead of matching device types; Wi-Fi metrics always collected
...
| `shelly_device_wifi_sta`  | `device_mac`                                                           | Wi-Fi station enabled        |
| `shelly_device_wifi_ap`   | `device_mac`                                                           | Wi-Fi AP enabled             |
...
| `shelly_system_wifi_rssi` | `device_mac`, `ssid`, `sta_ip`                                         | Wi-Fi signal strength in dBm |
